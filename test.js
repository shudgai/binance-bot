                ...
                if (res.ok) {
                    ...
                    if (data.status === 'success') {
                        if (data.cooldown) {
                            ...
                            if (symbols.length > 0) {
                                addLog(`🎯 狙擊成功！已選出 ${symbols.length} 個熱門小幣`, "success");
