...
COIN_PROFILE_CONFIG = {
    ...
    # 新幣/特殊調整
    "BTWUSDT":  {"sl_atr_multiplier": 2.5, "tp_atr_multiplier": 8.0,  "volume_threshold_factor": 1.2, "breakeven_trigger": 1.2, "min_flip_time": 1800, "mtf_filter": True,  "profile_type": "Speculative_Risk",   "leverage": 2, "rr_threshold": 2.2, "min_signal_strength": 22.0, "hard_sl_pct": 0.020, "disable_rescue_dca": True},
    # 第二類：高彈性動能型
