...
COIN_PROFILE_CONFIG = {
    ...
    "RIFUSDT": {"sl_atr_multiplier": 2.5, "tp_atr_multiplier": 8.0, "volume_threshold_factor": 1.0, "profile_type": "Speculative_Risk", "leverage": 2, "rr_threshold": 2.0, "min_signal_strength": 17.0, "support_zone_tolerance_pct": 0.10, "support_zone_strength_threshold": 24.0},
    "OUSDT":   {"sl_atr_multiplier": 2.5, "tp_atr_multiplier": 8.0, "volume_threshold_factor": 1.0, "profile_type": "Speculative_Risk", "leverage": 2, "rr_threshold": 2.0, "min_signal_strength": 17.0, "support_zone_tolerance_pct": 0.06, "support_zone_strength_threshold": 24.0},
    "UBUSDT":  {"sl_atr_multiplier": 2.5, "tp_atr_multiplier": 8.0, "volume_threshold_factor": 1.0, "profile_type": "Speculative_Risk", "leverage": 2, "rr_threshold": 2.0, "min_signal_strength": 17.0, "support_zone_tolerance_pct": 0.06, "support_zone_strength_threshold": 24.0},
    # 第二類：高彈性動能型
